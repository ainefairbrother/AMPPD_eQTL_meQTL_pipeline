...
#       covariates_file_name = paste0("./MatrixEQTL_input/covariates/celltype_PP_samples_filtered/",cohort,"_",diag,"_maf0.05_cov_table_for_MatrixEQTL.csv"),
...
#       output_file_name = paste0("./MatrixEQTL_output/celltype_PP_samples_filtered/",cohort,"_",diag,"_pheno=_maf=0.05_phenotype=expression_model=LINEAR_MatrixEQTL.csv"),
...
# 
#   run.matrixeqtl(
#     SNP_file_name = paste0("./MatrixEQTL_input/genomics/celltype_PP_samples_filtered/",cohort,"_cohort_all_chrs-maf0.05_geno_matrix_012_wrangled-8b.csv"),
#     # include pheno= in pheno_file_name as a placemarker for the run.matrixeqtl function to replace it with the actual phenotype label
#     pheno_file_name = paste0("./MatrixEQTL_input/transcriptomics/celltype_PP_samples_filtered/",cohort,"_cohort_pheno=_log10_mediannorm_TPM_masked_outliers_q1-3iqr_q3+3iqr_MT_ONLY.csv"),
#     covariates_file_name = paste0("./MatrixEQTL_input/covariates/celltype_PP_samples_filtered/",cohort,"_cohort_maf0.05_cov_table_for_MatrixEQTL.csv"),
#     # include pheno= in output_file_name as a placemarker for the run.matrixeqtl function to replace it with the actual phenotype label
#     output_file_name = paste0("./MatrixEQTL_output/celltype_PP_samples_filtered/",cohort,"_cohort_pheno=_maf=0.05_phenotype=expression_model=LINEARCROSS_MatrixEQTL.csv"),
...
#       covariates_file_name = paste0("./MatrixEQTL_input/covariates/celltype_PP_samples_filtered/",cohort,"_",diag,"_maf0.05_cov_table_for_MatrixEQTL.csv"),
#       # include pheno= in output_file_name as a placemarker for the run.matrixeqtl function to replace it with the actual phenotype label
#       output_file_name = paste0("./MatrixEQTL_output/celltype_PP_samples_filtered/",cohort,"_",diag,"_pheno=_maf=0.05_phenotype=methylation_model=LINEAR_MatrixEQTL.csv"),
#       which_model="modelLINEAR",
...
for(cohort in c("PP")){ 
  ...
  run.matrixeqtl(
    SNP_file_name = paste0("./MatrixEQTL_input/genomics/celltype_PP_samples_filtered/",cohort,"_cohort_all_chrs-maf0.05_geno_matrix_012_wrangled-8b.csv"),
    # include pheno= in pheno_file_name as a placemarker for the run.matrixeqtl function to replace it with the actual phenotype label
    pheno_file_name = paste0("./MatrixEQTL_input/methylomics/celltype_PP_samples_filtered/",cohort,"_cohort_pheno=_methylation_matrix_MatrixEQTL_input.csv"),
    covariates_file_name = paste0("./MatrixEQTL_input/covariates/celltype_PP_samples_filtered/",cohort,"_cohort_maf0.05_cov_table_for_MatrixEQTL.csv"),
    # include pheno= in output_file_name as a placemarker for the run.matrixeqtl function to replace it with the actual phenotype label
    output_file_name = paste0("./MatrixEQTL_output/celltype_PP_samples_filtered/",cohort,"_cohort_pheno=_maf=0.05_phenotype=methylation_model=LINEARCROSS_MatrixEQTL.csv"),
    which_model="modelLINEAR_CROSS",
    which_pheno="methylation"
  )
}
