...
plink2 --vcf PD_all_chrs-maf0.05-filtered.vcf.recode.vcf.gz --make-bed --out PD_all_chrs_maf0.05
plink2 --vcf PP_all_chrs-maf0.05-filtered.vcf.recode.vcf.gz --make-bed --out PP_all_chrs_maf0.05
plink2 --vcf BF_all_chrs-maf0.05-filtered.vcf.recode.vcf.gz --make-bed --out BF_all_chrs_maf0.05
